 ...
 * Ughh...
 * 
 * Given that the original {@link DialogComponentBoolean} has
 * VERY annoyingly declared final, for the simple and trivial
 * purpose of adding it an on click action button the ENTIRE
 ...
 */
public final class DialogComponentCheckboxWithActionListener extends DialogComponent {
     ...
     */
    public DialogComponentCheckboxWithActionListener(final SettingsModelBoolean booleanModel,
            final String label) {
        super(booleanModel);
